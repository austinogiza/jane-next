...
<Logouticon/></Cartlogout> </> }

<Cartsignin> <Link to='/account'><Signinicon /></Link></Cartsignin>
            <Carticon>
              {cart !== null && <Link to='/cart'> <Carticonsmall /> {cart !== null && cart.order_items.length }  </Link>  } {emptyCart && <> <Link to='/cart'> <Carticonsmall /> 0 </Link> </>}
            </Carticon>
